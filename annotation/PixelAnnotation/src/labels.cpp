...
Name2Labels defaulfLabels() {
	...
	labels["unlabeled"           ] = LabelInfo("unlabeled"           , "flat"         ,  00, 0, QColor(0,  0,  0));
//	labels["crack"               ] = LabelInfo("crack"               , "void"         ,  01, 0, QColor(245, 124,0 ));
...
//	labels["uname"                ] = LabelInfo("uname"             , "flat"         ,  7, 1, QColor(128, 64,128));
