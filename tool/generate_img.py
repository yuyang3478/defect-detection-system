...
class DataAug():
    ...
    def aug_img(self,):
        self.seed_img = "/home/tenghui/crack/ll/"
        self.num_after_gen = 340
        imgsount = len(
        ...
        for f in os.listdir(self.seed_img):
            if not os.path.isfile(os.path.join(self.seed_img,f)):
                continue
            ...
            for i in range(0,iter_steps):
                ...
                images_aug_tmp = seq1.augment_images(images)
                ...
                cv2.imwrite(os.path.join("/home/tenghui/crack/selected/test/gen/","sample_"+f[:-4] + str(i) + ".jpg"), images_aug_tmp[0])
